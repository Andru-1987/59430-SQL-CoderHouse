...
CREATE TABLE    donaton.categoria_donacion(
    id_categoria_donacion INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    descripcion VARCHAR(200),
    tipo VARCHAR(200)
);

CREATE TABLE    donaton.centro_recepcion(
...
CREATE TABLE    donaton.voluntario(
    id_voluntario INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    nombre VARCHAR(200) NOT NULL,
    fecha_nacimiento DATE
);

CREATE TABLE    donaton.categoria_voluntario(
...
CREATE TABLE    donaton.beneficiario(
...
CREATE TABLE    donaton.centro_recepcion_beneficiario(
...
CREATE TABLE    donaton.centro_recepcion_voluntario(
...
CREATE TABLE    donaton.voluntario_categoria(
